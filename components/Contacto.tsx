...
export default function Contacto() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const mensajeWhatsApp = `Hola! Mi nombre es *${formData.nombre}*%0A%0A${formData.mensaje}%0A%0A_Mi email: ${formData.email}_`;
    
    // TU NÚMERO DE WHATSAPP (reemplaza con tu número real)
    // Formato: código de país + número sin espacios ni guiones
    // Ejemplo Argentina: 5491234567890
    const numeroWhatsApp = '5493585186440'; // ← CAMBIA ESTE NÚMERO
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="space-y-3">
                ...
                <p className="text-gray-medium">
                  <span className="font-bold text-gray-dark">Email:</span> contacto@pintura.com
                </p>
              </div>
            </div>
          </div>
